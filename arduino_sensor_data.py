...
while True:
        ...
        rain = float(split_string[1])  # convert second part of string into float
        photoResistorValue = float(split_string[2])  # convert third part of string into float
        photoResistorLED = str(split_string[3])  # convert fourth part of string into float
        revolution = float(split_string[4])  # convert fifth part of string into float
        rpm = float(split_string[5])  # convert sixth part of string into float
        windSpeedKPH = float(split_string[6])  # convert seven part of string into float
        windDirection = float(split_string[7])  # convert eighth part of string into float
        co2Level = float(split_string[8])  # convert ninth part of string into float
