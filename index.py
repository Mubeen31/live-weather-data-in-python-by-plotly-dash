    ...
    return [
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    html.P('{0:,.0f}°C'.format(dew_point),
                           className = 'number_value'
                           ),
...
@app.callback(Output('forecast_status', 'children'),
              [Input('update_value', 'n_intervals')])
def weather_value(n_intervals):
    header_list = ['Humidity', 'Rain', 'Photo Resistor Value', 'Photo Resistor LED', 'Revolution', 'RPM',
                   'Wind Speed KPH', 'Wind Direction', 'CO2 Level', 'Temperature', 'Air Pressure']
    ...
    if time_name >= '12:00:00' and time_name < '23:59:59':
        if time_name >= '12:00:00' and time_name <= '12:59:59':
            return [
                html.Div([
                    html.Div([
                        html.Div([
        ...
        if time_name >= '13:00:00' and time_name <= '13:59:59':
            return [
                html.Div([
                    html.Div([
                        html.Div([
    ...
    elif time_name >= '00:00:00' and time_name < '12:00:00':
